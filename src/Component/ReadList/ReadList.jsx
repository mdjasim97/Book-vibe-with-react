...
const BooksList = () => {
    ...
    useEffect(() => {
        const bookList = getReadsBookStorage();
    ...
    return (
        <div className='lg:my-10'>
            {/* <div className=''>
                <h1 className='text-5xl font-bold text-center'>Read List : {bookList.length} </h1>
            </div> */}

            {
                bookList.map(book => <div className='grid grid-cols-1 border rounded-2xl my-6 lg:grid-cols-6'>
                    <div className='p-4'>
                    ...
                    <div className="lg:col-span-4 lg:space-y-5 lg:my-4 p-4  lg:mx-8">
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-3 space-y-2 mt-4'>
                            <button className='btn rounded-full mr-4 bg-[#d1e4fc] text-[#328EFF]'>Catagory : {book["category"]}</button>

                            <button className='btn rounded-full mr-4 bg-[#fad9c3] text-[#e29876]'>Rating : {book["rating"]}</button>
